...
public class BlutsteinClaymoreItem extends ClaymoreItem {
    public BlutsteinClaymoreItem(Properties properties) {
        super(ModTiers.BLUTSTEIN_TIER, 4, -2.4f,  properties);
    }
